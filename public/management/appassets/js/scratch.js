...
window.Fastor = {}, window.Fastor = window.Fastor || {}, Fastor.Sections = function () {
    ...
    _createInstance: function (e, t) {
        var a = e.getAttribute("data-section-id"), i = e.getAttribute("data-section-type");
...
}), window.Fastor = window.Fastor || {}, Fastor.Filters = function () {
    var e = Math.floor;

    function t(e) {
        this.$container = e, this._refresh(), on(this.containerSelect, "change", a.sortSelection, this._onSortChangeAjax.bind(this)), on(this.containerSelect, "change", a.limitSelection, this._onLimitChangeAjax.bind(this)), on(this.containerSelect, "input", a.filterForm, this._onFilterFormChangeAjax.bind(this)), on(this.containerSelect, "click", a.layoutChoice, this._onLayoutChangeAjax.bind(this)), on(this.containerSelect, "click", a.paginationPage, this._onPagingAjax.bind(this)), this._initInfiniteAjax(), this._initHorizontalFilter(), this._initParams()
    }
    ...
    return t.prototype = Object.assign({}, t.prototype, {
        _refresh: function () {
            ...
            var e, t = this.infiniteAjaxWrapperSelector, a = this, i = function () {
                window.pageYOffset > e + $(t).outerHeight() - window.innerHeight - 150 && "loading" != $(t).data("load-state") && ($(t).data("load-state", "loading"), $.ajax({
                    url: $(t).attr("data-next-url"),
                    success: function (e) {
                        var r = $(e).find(a.productsWrapperSelector).children();
                        $(t).attr("data-next-url", $(e).find(a.productsWrapperSelector).attr("data-next-url")), $(t).next().hasClass("load-more-overlay") ? $(t).next().addClass("loading") : $("<div class=\"pb-6 load-more-overlay loading\"></div>").insertAfter($(t)), setTimeout(function () {
                            $(t).next().removeClass("loading"), $(t).append(r), setTimeout(function () {
                                $(t).find(".product-wrap.fade:not(.in)").addClass("in"), Fastor.ProductItems.init()
                            }, 200), $(t).data("load-state", "loaded")
                        }, 500), "" == $(t).attr("data-next-url") && window.removeEventListener("scroll", i, {passive: !0})
                    },
                    failure: function () {
            ...
            if (this.queryParams = new FormData, location.search.length) for (var e, t = location.search.substr(1).split("&"), a = 0; a < t.length; a++) e = t[a].split("="), 1 < e.length && this.queryParams.append(decodeURIComponent(e[0]), decodeURIComponent(e[1]))
        }, _ajaxCall: function (e) {
            this.$container.classList.remove("loaded"), fetch(e).then(function (e) {
                return e.text()
            }).then(function (t) {
                var a = new DOMParser, i = a.parseFromString(t, "text/html"), r = i.querySelector(this.containerSelect);
            ...
            var t = e.target.closest(a.filterChoice), i = "/collections/" + this.collectionHandle;
            this.queryParams.delete("page");
            var r = ["sort_by", "view", "lo", "token", "limit"], o = [];
            ...
            "LI" == t?.parentNode.tagName && t?.parentNode.classList.toggle("active"), this.$container.classList.contains(this.indropdownFilterTemplateClass) && $(t)?.parents("." + this.indropdownSelectMenuClass).toggleClass(this.indropdownFilterToggleClass);
            this._ajaxCall(i + "?" + l)
            ...
            var a = t.getAttribute("href"), i = a.split("page="), r = i[1];
    ...
    Fastor.$window = e(window), Fastor.$body = e(document.body), Fastor.status = "", Fastor.minDesktopWidth = 992, Fastor.isIE = 0 <= navigator.userAgent.indexOf("Trident"), Fastor.isEdge = 0 <= navigator.userAgent.indexOf("Edge"), Fastor.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), Fastor.call = function (e, t) {
        setTimeout(e, t)
    ...
    var e, t, r, s, n, l, d, c, p = [], u = !1, m = function () {
        for (var a = p.length; a--;) e = p[a], t = window.pageXOffset, r = window.pageYOffset, s = e.el.getBoundingClientRect(), n = s.left + t, l = s.top + r, d = e.options.accX, c = e.options.accY, l + s.height + c >= r && l <= r + window.innerHeight + c && n + s.width + d >= t && n <= t + window.innerWidth + d && (e.fn.call(e.el, e.data), p.splice(a, 1))
    };
    Fastor.appear = function (e, t, a) {
        var i = {data: void 0, accX: 0, accY: 0};
        a && (a.data && (i.data = a.data), a.accX && (i.accX = a.accX), a.accY && (i.accY = a.accY)), p.push({
            el: e,
            fn: t,
            options: i
        }), u || (u = Fastor.requestTimeout(m, 100))
    }, window.addEventListener("scroll", m, {passive: !0}), window.addEventListener("resize", m, {passive: !0}), $(window).on("appear.check", m)
}(), function (t) {
    Fastor.zoomImageOptions = {
        ...
        zoomType: "inner",
        cursor: "crosshair"
    }, Fastor.zoomImageObjects = [], Fastor.zoomImage = function (e) {
        t.fn.elevateZoom && e && ("string" == typeof e ? t(e) : e).find("img").each(function () {
            var e = t(this);
        ...
        t.fn.countTo && Fastor.$(e).each(function () {
        ...
        t.fn.countdown && Fastor.$(e).each(function () {
            var e, a = t(this), i = a.data("until"), r = a.data("compact"),
                ...
                l = i.split("-"), e = new Date(l[2], l[0] - 1, l[1]), d = new Date;
            return e.setHours(0, 0, 0, 0) <= d.setHours(0, 0, 0, 0) ? void a.hide() : void a.countdown({
                until: e,
                compact: r,
                compactLabels: ["y", "m", "w", "days, "],
                layout: "<div class=\"countdown-block\">{d<}{dn}<span>{dl}<span></div><div class=\"countdown-block\">{d>}{h<}{hn}<span>{hl}<span></div><div class=\"countdown-block\">{h>}{m<}{mn}<span>{ml}<span></div><div class=\"countdown-block second\"> {m>}{s<}{sn}<span>{sl}<span>{s>}</div>",
                labels: ["Y", "M", "W", "D", "H", "Mi", "S"]
            })
        })
    }, Fastor.isotopeOptions = {
        ...
        t.fn.isotope && Fastor.$(e).on("click", function (a) {
            var e = t(this), i = e.attr("data-filter"), r = e.parent().parent().attr("data-target");
        ...
        t.fn.themePluginParallax && Fastor.$(e).each(function () {
            var e = t(this);
            e.themePluginParallax(t.extend(!0, Fastor.parseOptions(e.attr("data-parallax-options")), a))
        })
    }, Fastor.stickyDefaultOptions = {
        minWidth: 992,
        maxWidth: 2e4,
        top: !1,
        hide: !1
    }, Fastor.stickyContent = function (e, a) {
        var i = Fastor.$(e), r = t.extend({}, {
            minWidth: Fastor.minDesktopWidth,
            maxWidth: 2e4,
            top: 300,
            hide: !1,
            max_index: 1060,
        ...
        if (0 != i.length) {
            var s = function (e) {
                ...
                }), e.data("offset-top", a), e.data("z-index", r.max_index - i)
            }, n = function (e) {
                var a = 0, i = 0;
                t(".sticky-content.fixed.fix-bottom").each(function () {
                    a += t(this)[0].offsetHeight, i++
                }), e.data("offset-bottom", a), e.data("z-index", r.max_index - i)
            }, l = function (e, t) {
                ...
                i.removeData("offset-top").removeData("offset-bottom").removeClass("fixed").css("margin", "").css("z-index", ""), Fastor.call(function () {
                    d(), c()
                })
            };
            setTimeout(d, 550), setTimeout(c, 600), Fastor.call(function () {
        ...
        Fastor.$body.on("click", e, function (i) {
            var e = t(this), r = e.closest(".card").find(e.attr("href")), o = e.closest(".accordion");
            i.preventDefault(), 0 === o.find(".collapsing").length && 0 === o.find(".expanding").length && (r.hasClass("expanded") ? !o.hasClass("radio-type") && a(r) : r.hasClass("collapsed") && (0 < o.find(".expanded").length ? Fastor.isIE ? a(o.find(".expanded"), function () {
                a(r)
            }) : (a(o.find(".expanded")), a(r)) : a(r)))
        });
        var a = function (t, a) {
        ...
        Fastor.$body.on("click", ".tab .nav-link", function (a) {
            var e = t(this);
            ...
            var e = t(a.currentTarget).attr("href"), i = t(e), r = i.parent().siblings(".nav");
            a.preventDefault(), i.siblings().removeClass("active in"), i.addClass("active in"), r.find(".nav-link").removeClass("active"), r.find("[href=\"" + e + "\"]").addClass("active"), t("html").animate({scrollTop: i.offset().top - 150})
        })
        ...
        Fastor.$(e).each(function () {
            var e = this;
            if (!Shopify.designMode && !1 == a) Fastor.appear(e, function () {
                if (e.classList.contains("appear-animate")) {
                    ...
                    Fastor.call(function () {
                        e.style["animation-duration"] = a.duration, e.style["animation-delay"] = a.delay, e.classList.add(a.name), setTimeout(function () {
                ...
                Fastor.call(function () {
                    e.style["animation-duration"] = i.duration, e.style["animation-delay"] = i.delay, e.classList.add(i.name), setTimeout(function () {
                        e.classList.add("appear-animation-visible")
        ...
        "object" == typeof noUiSlider && Fastor.$(e).each(function () {
            var n = this;
            noUiSlider.create(n, t.extend(!0, {
                start: [o, s],
                connect: !0,
                step: 1,
                range: {min: i, max: r}
            }, a)), n.noUiSlider.on("update", function (e) {
                var e = e.map(function (e) {
                    return "$" + parseInt(e)
                });
                t(n).parent().find(".filter-price-range").text(e.join(" - "))
            }), n.noUiSlider.on("end", function (e) {
                var a = parseInt(e[0]), i = parseInt(e[1]);
                t(n).parent().find(".filter-price--min").val(a), t(n).parent().find(".filter-price--max").val(i)
            }), t(n).parent().find(".price-filter-action").on("click", function () {
        ...
        init: function () {
            ...
            t(".menu li").each(function () {
                ...
                t(".main-nav .megamenu").each(function () {
                    var e = t(this), a = e.offset().left, i = e.outerWidth(), r = a + i - (window.innerWidth - 20);
            ...
            if (e.length) {
                ...
                if (a.length) {
                    ...
                    (window.pageYOffset > i || 992 > window.innerWidth) && e.removeClass("show"), window.addEventListener("scroll", function () {
                ...
                if (e.hasClass("with-sidebar")) {
                    ...
                    r.length && (e.find(".dropdown-box").css("width", r[0].offsetWidth - 20), Fastor.$window.on("resize", function () {
            ...
            }), t(".widget-collapsible .widget-title").off("click").on("click", function () {
                var e = t(this), a = e.siblings(".widget-body");
...
(function (e) {
    ...
    Popup.defaults = {
        ...
        }, 500)) : e.magnificPopup.open(e.extend(!0, {}, Popup.defaults, a ? Popup.presets[a] : {}, t))
...
(function (t) {
    'use strict';
    var e = Math.max, a = function () {
        992 > window.innerWidth && (this.$sidebar.find(".sidebar-content, .filter-clean").removeAttr("style"), this.$sidebar.find(".sidebar-content").attr("style", ""), this.$sidebar.siblings(".toolbox").children(":not(:first-child)").removeAttr("style"))
    };
    Sidebar.prototype.init = function (i) {
        var r = this;
        return r.name = i, r.$sidebar = t("." + i), r.isNavigation = !1, r.$sidebar.length && (r.isNavigation = r.$sidebar.hasClass("sidebar-fixed") && r.$sidebar.parent().hasClass("toolbox-wrap"), r.isNavigation && (a = a.bind(this), Fastor.$window.on("resize", a)), Fastor.$window.on("resize", function () {
            Fastor.$body.removeClass(i + "-active")
        }), r.$sidebar.find(".sidebar-toggle, .sidebar-toggle-btn").add("sidebar" === i ? ".left-sidebar-toggle" : "." + i + "-toggle").on("click", function (a) {
        ...
        if (992 <= window.innerWidth && a.$sidebar.hasClass("sidebar-fixed")) {
            ...
            if (a.isNavigation && (i || a.$sidebar.find(".filter-clean").hide(), a.$sidebar.siblings(".toolbox").children(":not(:first-child)").fadeToggle("fast"), a.$sidebar.find(".sidebar-content").stop().animate({
                height: "toggle",
                "margin-bottom": i ? "toggle" : -6
            }, function () {
                ...
                if (r.length) if (r.hasClass("product-lists")) r.toggleClass("row cols-xl-2", !i); else {
                    var o = r.data("toggle-cols"), s = r.attr("class").match(/cols-\w*-*\d/g),
                        n = s ? e.apply(null, s.map(function (e) {
                            return e.match(/\d/)[0]
                        })) : 0;
                    i ? (4 === n && 3 == o && r.removeClass("cols-md-4"), t(".btn-layout").removeClass("active"), t(".btn-layout[data-value='grid-3']").addClass("active")) : 3 === n && (r.addClass("cols-md-4"), t(".btn-layout").removeClass("active"), t(".btn-layout[data-value='grid-4']").addClass("active"), !o && r.data("toggle-cols", 3))
                }
            }
            a.$sidebar.toggleClass("closed")
        } else a.$sidebar.find(".sidebar-overlay .sidebar-close").css("margin-left", -(window.innerWidth - document.body.clientWidth)), Fastor.$body.toggleClass(a.name + "-active").removeClass("closed"), 1200 <= window.innerWidth && Fastor.$body.hasClass("with-flex-container") && t(".owl-carousel").trigger("refresh.owl.carousel")
    }, Fastor.sidebar = function (e) {
        return new Sidebar().init(e)
    }
})(jQuery), function (e) {
    'use strict';
    var t, a = 0, i = [], r = [], o = !1, s = !1, n = function () {
    ...
    Fastor.notifpopup = {
        ...
        defaults: {
            ...
            template: "<div class=\"notifpopup-box\"><p class=\"notifpopup-title border-none bg-light\">{{message}}</p><div class=\"product {{productClass}}\"><figure class=\"product-visual\"><a href=\"{{imageLink}}\"><img src=\"{{imageSrc}}\" alt=\"{{imageAlt}}\" width=\"90\" height=\"90\"></a></figure><div class=\"product-detail ml-4\"><a href=\"{{nameLink}}\" class=\"product-name\">{{name}}</a><div class=\"product-variant\">{{productDetails}}</div><div class=\"product-price\">{{price}}</div></div></div></div>"
        },
        init: function () {
            var a = document.createElement("div");
            a.className = "notifpopup-realm", Fastor.byClass("page-wrapper")[0].appendChild(a), t = e(a), t.on("click", ".btn-close", function () {
                self.close(e(this).closest(".notifpopup-box").index())
            }), this.close = this.close.bind(this), n = n.bind(this)
        },
        open: function (o, l) {
            var d, c = this, p = e.extend(!0, {}, c.defaults, o);
            p.detailTemplate = Fastor.parseTemplate(null == p.count ? p.priceTemplate : p.priceQuantityTemplate, p), null != p.rating && (p.detailTemplate += Fastor.parseTemplate(p.ratingTemplate, p)), d = e(Fastor.parseTemplate(p.template, p)), d.appendTo(t).css("top", -a).find("img")[0].onload = function () {
                a += d[0].offsetHeight + c.space, d.addClass("show"), 0 > d.offset().top - window.pageYOffset && (c.close(), d.css("top", -a + d[0].offsetHeight + c.space)), d.on("mouseenter", function () {
                    c.pause()
                    ...
                    c.resume()
                }), i.push(d), r.push(p.delay), 1 < r.length || (s = setInterval(n, 200)), l && l(d)
            }
        },
        close: function (e) {
            var t = this, o = "undefined" == typeof e ? 0 : e, n = i.splice(o, 1)[0];
            r.splice(o, 1)[0], a -= n[0].offsetHeight + t.space, n.removeClass("show"), setTimeout(function () {
                n.remove()
    ...
    var e = function () {
        Fastor.$body.on("click", ".cart-offcanvas .cart-toggle", function (a) {
    ...
    Fastor.shop = {
        ...
        initVariation: function () {
            t(".product:not(.product-single) .product-variations > a").on("click", function (a) {
                var e = t(this), i = e.closest(".product").find(".product-visual img");
                i.data("image-src") || i.data("image-src", i.attr("src")), e.toggleClass("active").siblings().removeClass("active"), e.hasClass("active") ? i.attr("src", e.data("src")) : (i.attr("src", i.data("image-src")), e.blur()), a.preventDefault()
            })
        },
        initProductType: function (e) {
            "slideup" === e && (t(".product-slideup-content .product-details").each(function () {
                var e = t(this), a = e.find(".product-hide-details").outerHeight(!0);
                e.height(e.height() - a)
            }), t(Fastor.byClass("product-slideup-content")).on("mouseenter touchstart", function () {
                var e = t(this), a = e.find(".product-hide-details").outerHeight(!0);
        ...
        cartProducts: {
            productList: [{
                name: "Daisy Shoes Sonia by Sonia Rykiel - Blue, Large",
...
(function (t) {
    var e = function () {
        var e, t, a = ["", "-xs", "-sm", "-md", "-lg", "-xl"];
        for (this.classList.remove("row"), e = 0; 6 > e; ++e) for (t = 1; 12 >= t; ++t) this.classList.remove("cols" + a[e] + "-" + t);
        if (this.classList.remove("gutter-no"), this.classList.remove("gutter-sm"), this.classList.remove("gutter-lg"), this.classList.contains("animation-slider")) for (var r = this.children, o = r.length, e = 0; e < o; ++e) r[e].setAttribute("data-index", e + 1)
    }, a = function (a) {
        var e, r = this.firstElementChild.firstElementChild.children, o = r.length;
        for (e = 0; e < o; ++e) if (!r[e].classList.contains("active")) {
            var s, n = Fastor.byClass("appear-animate", r[e]);
            for (s = n.length - 1; 0 <= s; --s) n[s].classList.remove("appear-animate")
        }
        var l = t(a.currentTarget);
        l.find("video").on("ended", function () {
            var e = t(this);
            e.closest(".owl-item").hasClass("active") && (!0 === l.data("owl.carousel").options.autoplay ? (!1 === l.data("owl.carousel").options.loop && l.data().children - 1 === l.find(".owl-item.active").index() && (this.loop = !0, this.play()), l.trigger("next.owl.carousel"), l.trigger("play.owl.autoplay")) : (this.loop = !0, this.play()))
        })
    }, i = function (a) {
        t(window).trigger("appear.check");
        var e = t(a.currentTarget), i = e.find(".owl-item.active video");
        e.find(".owl-item:not(.active) video").each(function () {
            this.paused || e.trigger("play.owl.autoplay"), this.pause(), this.currentTime = 0
        }), i.length && (!0 === e.data("owl.carousel").options.autoplay && e.trigger("stop.owl.autoplay"), i.each(function () {
            this.paused && this.play()
        }))
    }, r = function (a) {
        var e = this, i = t(a.currentTarget);
        i.find(".owl-item.active .slide-animate").each(function () {
            var a = t(this),
                ...
                r = i.duration, o = i.delay, s = i.name;
            setTimeout(function () {
                ...
                r = r ? r : "0.75s";
                var i = Fastor.requestTimeout(function () {
        ...
        t(a.currentTarget).find(".owl-item.active .slide-animate").each(function () {
            var e = t(this);
            e.addClass("show-content"), e.attr("style", "")
        })
    }, s = function (a) {
        var e = this, i = t(a.currentTarget);
        e.translateFlag = 1, e.prev = e.next, i.find(".owl-item .slide-animate").each(function () {
            var e = t(this),
                a = t.extend(!0, {}, Fastor.animationOptions, Fastor.parseOptions(e.data("animation-options")));
            e.removeClass(a.name)
        })
    }, n = function (a) {
        var e = this, r = t(a.currentTarget);
        if (1 == e.translateFlag) {
            if (e.next = r.find(".owl-item").eq(a.item.index).children().attr("data-index"), r.find(".show-content").removeClass("show-content"), e.prev != e.next) {
                ...
                r.find(".owl-item.active .slide-animate").each(function () {
                    ...
                    r = r ? r : "0.75s";
                    var l = Fastor.requestTimeout(function () {
    ...
    Slider.defaults = {
        ...
        var c = this, p = l.attr("class").split(" "), u = t.extend(!0, {}, Slider.defaults);
    ...
    window.Fastor = window.Fastor || {}, Fastor.HeaderSection = function () {
        return function (e) {
        ...
        _init: function () {
            Fastor.menu.init(), Fastor.menu.initCategoryMenu(), document.querySelectorAll("[data-predictive-search-open-drawer], [data-predictive-search-start], [data-predictive-search-mobile-start]").forEach(e => {
    ...
    }), window.Fastor = window.Fastor || {}, Fastor.SlideshowSection = function () {
        return function (e) {
        ...
        _init: function () {
            ...
            var a = this.container.querySelector(".slideshow__slide--" + t.detail.blockId),
                i = a.getAttribute("data-slider-slide-index"), r = this;
            Fastor.call(function () {
                e("#slider-" + r.sectionId).trigger("to.owl.carousel", i)
            }, 500)
        }, onBlockDeselect: function () {
        }
    }), window.Fastor = window.Fastor || {}, Fastor.CategoriesListSection = function () {
        return function (e) {
            var t = this.sectionId = e.dataset.sectionId;
            this.container = e, this.sectionNamspace = "#" + t, this._init()
        }
    ...
    }), window.Fastor = window.Fastor || {}, Fastor.ProductsListSection = function () {
        return function (e) {
            var t = this.sectionId = e.dataset.sectionId;
            this.container = e, this.sectionNamspace = "#" + t, this._init()
        }
    ...
    }), window.Fastor = window.Fastor || {}, Fastor.BannerSection = function () {
        return function (e) {
            var t = this.sectionId = e.dataset.sectionId;
            this.container = e, this.sectionNamspace = "#" + t, this._init()
        }
        ...
        _init: function () {
            Fastor.appearAnimate(".appear-animate"), e(this.sectionNamspace).hasClass("parallax") && Fastor.parallax(this.sectionNamspace), Fastor.parallax(this.sectionNamspace + " .parallax"), Fastor.slider(this.sectionNamspace + " .owl-carousel")
        }, onUnload: function () {
        }, onBlockSelect: function () {
        }, onBlockDeselect: function () {
        }
    }), window.Fastor = window.Fastor || {}, Fastor.MobileMenuSection = function () {
        return function (e) {
            var t = this.sectionId = e.dataset.sectionId;
        ...
        _init: function () {
            const e = new MmenuLight(document.querySelector(this.menuNamspace), "(max-width: 991px)"),
                t = e.navigation(), a = e.offcanvas();
            document.querySelector("a[href='" + this.menuNamspace + "']").addEventListener("click", e => (e.preventDefault(), document.querySelector("body.mm-ocd-opened") ? void a.close() : void a.open())), document.querySelector("[data-mobile-menu-toggle]").addEventListener("click", () => {
    ...
    def: "easeOutQuad", swing: function (e, a, t, i, r) {
    ...
    var i = !1, r = {preventScrolling: "prevent-scrolling"}, o = window.pageYOffset;
    return {
        setTouch: function () {
            i = !0
        }, isTouch: e, enableScrollLock: t, disableScrollLock: a, debounce: function (e, t, a) {
            var i;
            return function () {
                var r = this, o = arguments, s = a && !i;
            ...
            return new Promise(function (a, i) {
                ...
                var o = document.createElement("script"), s = t || document.getElementsByTagName("script")[0];
   ...
   */, serialize: function (e) {
            ...
            return Array.prototype.slice.call(e.elements).forEach(function (e) {
                return !e.name || e.disabled || -1 < ["file", "reset", "submit", "button"].indexOf(e.type) ? void 0 : "select-multiple" === e.type ? void Array.prototype.slice.call(e.options).forEach(function (a) {
            ...
            return "undefined" == typeof this.stylesheetPromise && (this.stylesheetPromise = new Promise(function (e) {
                var a = document.querySelector("link[href=\"" + t + "\"]");
                a.loaded && e(), a.addEventListener("load", function () {
                    setTimeout(e, 0)
                })
    ...
    var a = {link: "link", script: "script"}, i = {requested: "requested", loaded: "loaded"},
        r = "https://cdn.shopify.com/shopifycloud/", o = {
    ...
    return {
        load: function (r, s) {
            ...
            if (n && n.status !== i.requested) {
                if (s = s || function () {
                }, n.status === i.loaded) return void s();
    ...
    return {
        preload: function (e, t) {
            ...
            var i = this.imageSize(t.src), r = this.getSizedImageUrl(e.src, i);
            a ? a(r, e, t) : t.src = r
    ...
    return {
        formatMoney: function (e, t) {
            function a(e, t, a, i) {
                ...
                e = (e / 100).toFixed(t);
                var r = e.split("."), o = r[0].replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1" + a), s = r[1] ? i + r[1] : "";
                return o + s
            }

            "string" == typeof e && (e = e.replace(".", ""));
            var i = "", r = /\{\{\s*(\w+)\s*\}\}/, o = t || "${{amount}}";
            switch (o.match(r)[1]) {
                case "amount":
                    i = a(e, 2);
                    break;
...
}(), window.Fastor = window.Fastor || {}, Fastor.Utils = function () {
    return {
...
}(), window.Fastor = window.Fastor || {}, Fastor.ProductItems = function () {
...
}(), window.Fastor = window.Fastor || {}, Fastor.ProductItem = function () {
    function e(e) {
        this.element = e, this.singleOptions = this.element.querySelectorAll(t.single_option), this.radioSwatches = this.element.querySelectorAll(t.swatch_radio), this.product = {}, this.handleFeaturedProduct(), this.handleAddToCart()
    }
    ...
    return e.prototype = Object.assign({}, e.prototype, {
        handleAddToCart: function () {
            var e = this.element.querySelector(t.addToCartForm), a = this.element.querySelector(t.addToCart);
            e && (a.addEventListener("click", function (t) {
            ...
            0 == this.element.querySelectorAll(t.item_json_wrapper).length || (this.product = JSON.parse(this.element.querySelector(t.item_json_wrapper).innerHTML), this.singleOptions.forEach(function (e) {
                e.addEventListener("change", this._onOptionSelectorChange.bind(this))
            }.bind(this)), this.radioSwatches.forEach(function (e) {
            ...
            e.preventDefault();
            var a = e.target.getAttribute("data-value"), i = e.target.closest(t.option_wrapper).querySelector("select"),
                r = i.value;
            r != a && (i.value = a, i.dispatchEvent(new Event("change", {
                bubbles: !0,
                cancelable: !0
            })), e.target.closest(t.option_wrapper).querySelectorAll(".swatch-radio").forEach(function (e) {
                e.classList.remove("selected")
            }), e.target.closest(t.option_wrapper).querySelectorAll("label").forEach(function (e) {
            ...
            return this.singleOptions.forEach(function (t) {
                ...
                (!("radio" === a || "checkbox" === a) || t.checked) && e.push({
                    value: t.value,
                    index: t.getAttribute("data-index")
                })
            }), e
        }, _getVariantFromOptions: function () {
            var e = this._getCurrentOptions(), t = this.product.variants, a = t.find(function (t) {
            ...
            var a = this.element.querySelector(t.addToCart), i = this.element.querySelector(t.addToCartText);
            e ? e.available ? (a.disabled = !1, a.setAttribute("title", theme.strings.addToCart)) : (a.disabled = !0, a.setAttribute("title", theme.strings.soldOut)) : (a.disabled = !0, a.setAttribute("title", theme.strings.unavailable))
            ...
            return !e && a ? (a.classList.add(t.productUnavailable), void a.setAttribute("aria-hidden", !0)) : void (!e.available && a && a.classList.add(t.productSoldOut), e.compare_at_price > e.price ? (i && (i.classList.remove("hide"), i.innerHTML = theme.Currency.formatMoney(e.compare_at_price, theme.moneyFormat)), r && (r.innerHTML = theme.Currency.formatMoney(e.price, theme.moneyFormat)), a && (a.classList.add(t.productOnSale), a.setAttribute("data-price", e.price), a.setAttribute("data-price_old", e.compare_at_price))) : (r && (r.innerHTML = theme.Currency.formatMoney(e.price, theme.moneyFormat)), i && i.classList.add("hide"), a && (a.setAttribute("data-price", e.price), a.setAttribute("data-price_old", "0"))), null != this.element.closest(".grouped-product") && Fastor.updateGroupedPrice())
        }
    }), e
}(), window.slate = window.slate || {}, slate.Variants = function () {
    function e(e) {
    ...
    return e.prototype = Object.assign({}, e.prototype, {
        _getCurrentOptions: function () {
            ...
            var t = e.featured_image || {}, a = this.currentVariant.featured_image || {};
    ...
    function o(e, t) {
        var a = A[e], i = T[e], r = a.videoWrapper;
        if (x) c(a); else {
    ...
    function c(e) {
        var t = e.videoWrapper, a = t.querySelector(M.pauseVideoBtn);
        t.classList.remove(P.loading), a.classList.contains(P.userPaused) && a.classList.remove(P.userPaused);
        "background" === e.status || (document.getElementById(e.id).setAttribute("tabindex", "0"), "image_with_play" === e.type && (t.classList.remove(P.paused), t.classList.add(P.playing)), setTimeout(function () {
    ...
    function g(e, t) {
        var a = A[e], i = a.videoWrapper.getBoundingClientRect().top + window.pageYOffset,
            r = a.videoWrapper.querySelector(M.playVideoBtn), o = 0, s = 0;
        if (S() && a.videoWrapper.parentElement.classList.toggle("page-width", !t), !t) {
            s = S() ? a.videoWrapper.dataset.mobileHeight : a.videoWrapper.dataset.desktopHeight, a.videoWrapper.style.height = s + "px", setTimeout(function () {
                a.videoWrapper.classList.add(P.wrapperMinHeight)
            }, 600);
            var n = window.scrollX, l = window.scrollY;
            r.focus(), window.scrollTo(n, l)
        } else if (s = S() ? window.innerWidth / E.ratio : a.videoWrapper.offsetWidth / E.ratio, o = (window.innerHeight - s) / 2, a.videoWrapper.style.height = a.videoWrapper.getBoundingClientRect().height + "px", a.videoWrapper.classList.remove(P.wrapperMinHeight), a.videoWrapper.style.height = s + "px", !(S() && Shopify.designMode)) {
    ...
    function h(e) {
        var t = A[e].videoWrapper.querySelector(M.pauseVideoBtn), r = t.classList.contains(P.userPaused);
    ...
    function f(t) {
        if (q) if (S()) t.style.cssText = null; else {
            var a = t.closest(M.videoWrapper), i = a.clientWidth, r = t.clientWidth, o = a.dataset.desktopHeight;
            if (i / E.ratio < o) {
                r = e(o * E.ratio);
    ...
    function b(e) {
        ...
        t.classList.remove(P.backgroundVideo), t.classList.add(P.videoWithImage), setTimeout(function () {
            document.getElementById(e).style.cssText = null
        }, 600), A[e].videoWrapper.classList.remove(P.backgroundVideoWrapper), A[e].videoWrapper.classList.add(P.playing), A[e].status = "open"
    }
    ...
    function C() {
        var e = document.querySelectorAll(M.playVideoBtn), t = document.querySelectorAll(M.closeVideoBtn),
        ...
        }), window.addEventListener("resize", O), window.addEventListener("scroll", B)
    }
    ...
    function w(e, t) {
        var a = e.querySelectorAll(M.playVideoBtn), i = e.querySelector(M.closeVideoBtn),
            r = e.querySelector(M.pauseVideoBtn), o = i.querySelector(M.fallbackText),
            s = r.querySelector(M.pauseVideoStop), n = s.querySelector(M.fallbackText),
            l = r.querySelector(M.pauseVideoResume), d = l.querySelector(M.fallbackText);
        a.forEach(function (e) {
            var a = e.querySelector(M.fallbackText);
            a.textContent = a.textContent.replace("[video_title]", t)
        }), o.textContent = o.textContent.replace("[video_title]", t), n.textContent = n.textContent.replace("[video_title]", t), d.textContent = d.textContent.replace("[video_title]", t)
    }

    var k = !1, I = !1, x = !1, q = !1, A = {}, T = [], E = {
        ratio: 16 / 9,
        ...
        events: {
            onReady: function (e) {
                ...
                var t = m(e), a = e.target.getVideoData().title;
    ...
    }, 200), B = theme.Helpers.debounce(function () {
        if (q) for (var e in A) if (A.hasOwnProperty(e)) {
            var t = A[e].videoWrapper,
                a = t.getBoundingClientRect().top + window.pageYOffset + .75 * t.offsetHeight < window.pageYOffset || t.getBoundingClientRect().top + window.pageYOffset + .25 * t.offsetHeight > window.pageYOffset + window.innerHeight;
    ...
    return {
        init: t, editorLoadVideo: r, loadVideos: function () {
            for (var e in A) A.hasOwnProperty(e) && L(e);
            C(), q = !0
        }, playVideo: a, pauseVideo: i, removeEvents: function () {
    ...
    var o = {}, s = {shopify: "shopify", external: "external"},
    ...
    return {
        init: function (i, r) {
            if (i) {
                ...
                if (s) {
                    ...
                    o[n] = {
                        mediaId: n, sectionId: r, host: a(s), container: i, element: s, ready: function () {
                            t(this)
                        }
        ...
        }, hosts: s, loadVideos: i, removeSectionVideos: function (e) {
    ...
    function t(e) {
        if (!e) for (var t in r) if (r.hasOwnProperty(t)) {
            var i = r[t];
    ...
    var i = {}, r = {}, o = {}, s = {mediaGroup: "[data-product-single-media-group]", xrButton: "[data-shopify-xr]"};
    return {
        init: function (a, n) {
            i[n] = {loaded: !1}, a.forEach(function (e, t) {
                var a = e.getAttribute("data-media-id"), i = e.querySelector("model-viewer"),
                    l = i.getAttribute("data-model-id");
                if (0 === t) {
                    var d = e.closest(s.mediaGroup), c = d.querySelector(s.xrButton);
                    o[n] = {element: c, defaultId: l}
                }
                r[a] = {modelId: l, sectionId: n, container: e, element: i}
            }), window.Shopify.loadFeatures([{name: "shopify-xr", version: "1.0", onLoad: e}, {
    ...
    var a = {imageZoom: "[data-image-zoom]"}, i = {zoomImg: "zoomImg"}, r = {imageZoomTarget: "data-image-zoom-target"};
    return t.prototype = Object.assign({}, t.prototype, {
        _cacheSelectors: function () {
            this.cache = {sourceImage: this.container.querySelector(a.imageZoom)}
        }, _init: function () {
            var e = this.cache.targetImage.width, t = this.cache.targetImage.height;
            ...
            return new Promise(function (e, t) {
                var a = new Image;
                a.setAttribute("role", "presentation"), a.setAttribute(r.imageZoomTarget, !0), a.classList.add(i.zoomImg), a.src = this.url, a.addEventListener("load", function () {
                    e(a)
    ...
    return e.prototype = Object.assign({}, e.prototype, {
        updateContent: function (e) {
            var a = this.container.dataset.baseUrl + "/variants/" + e + "/?section_id=store-availability", i = this,
                r = i.container.querySelector(t.storeAvailabilityModalOpen);
            this.container.style.opacity = .5, r && (r.disabled = !0, r.setAttribute("aria-busy", !0)), fetch(a).then(function (e) {
                return e.text()
            }).then(function (e) {
                "" !== e.trim() && (i.container.innerHTML = e, i.container.innerHTML = i.container.firstElementChild.innerHTML, i.container.style.opacity = 1, r = i.container.querySelector(t.storeAvailabilityModalOpen), r && ($(t.storeAvailabilityModalOpen).on("click", function (t) {
                    t.preventDefault(), Fastor.popup({items: {src: $(this).attr("href")}}, "storeAvailability")
                }), i._updateProductTitle(), i.hasOnlyDefaultVariant && i._hideVariantTitle()))
            })
    ...
    function r(e) {
        ...
        this.zoomPictures = [], this.ajaxEnabled = "direct" != theme.addToCartType, this.isQuickview = "product-quickview-template" == t, this.$wrapper = $(e), this.settings = {
    ...
    return r.prototype = Object.assign({}, r.prototype, {
        _initGroupedProduct: function () {
            ...
            0 == e.length || ($(document).on("change", this.selectors.groupedCheckbox, function () {
                ...
                var t = $(this);
                return t.find("i").addClass("position-static").addClass("loading"), t.prop("disable", !0), Shopify.queue = [], e.find(".grouped-checkbox").each(function () {
                    if ($(this).is(":checked")) {
                        var e = $($(this).data("id")).find("form .product__form_variant_id").val();
                        null !== e && Shopify.queue.push({variantId: e, quantity: 1})
                    }
                }), Shopify.moveAlong = function () {
                    if (Shopify.queue.length) var e = Shopify.queue.shift(), a = $.ajax({
                        type: "POST",
                        url: "/cart/add.js",
                        async: !0,
                        cache: !1,
                        ...
                        error: function (e) {
                            var t = $.parseJSON(e.responseText), a = t.message + ": " + t.description;
                            alert(a)
                        },
                        success: function (e) {
            ...
            if ($(this.selectors.totalSold).length) {
                var e = $(this.selectors.totalSold), t = e.data("qty_min"), r = e.data("qty_max"),
                    o = e.data("time_min"), s = e.data("time_max");
                ...
                l = parseInt(l), l <= o && (l = o), l > s && (l = s), e.html(e.html().replace("/time/", l)), e.addClass("active"), e.find("img").first().length && setInterval(function () {
            ...
            if ($(this.selectors.visitorCounter).length) {
                var s = $(this.selectors.visitorCounter), d = 1, c = s.data("max"), p = s.data("interval"), u = d,
                    m = c;
                u = a(u), m = i(m);
                var g = i(Math.random() * (m - u + 1)) + u,
                    y = ["1", "2", "4", "3", "6", "10", "-1", "-3", "-2", "-4", "-6"], n = "", v = "",
                    f = ["10", "20", "15"], n = "", v = "", l = "";
            ...
            if ($(this.selectors.stockCountdown).length) {
                var e = this, t = $(e.selectors.stockCountdown);
                if (t.hasClass("is-fake")) {
                    ...
                    function l() {
                        t.find(".stock-countdown-message").first().html(theme.strings.onlyLeft.replace("{{ count }}", o)), s = setTimeout(function () {
                    ...
                    var a = t.data("min"), r = t.data("max"), o = e(a, r), s = null, n = null;
            ...
            var e = this, t = $(e.selectors.cartAgree);
            0 == t.length || ($(document).on("DOMNodeInserted", e.selectors.cartCheckout, function () {
                ...
                var t = $(this), a = $(e.selectors.cartCheckout).find(".shopify-payment-button__button");
            ...
            function e() {
                var e, t = [], a = $(".product-single");
                return e = a.find(".product-single-carousel").length ? a.find(".product-single-carousel .owl-item:not(.cloned) img.feature-row__image") : a.find(".product-gallery-carousel").length ? a.find(".product-gallery-carousel .owl-item:not(.cloned) img.feature-row__image") : a.find(".product-gallery img.feature-row__image"), e.length && e.each(function () {
                    var e = $(this).data("zoomImage"), a = $(this).data("width"), i = $(this).data("height");
                    t.push({src: e, w: a, h: i, title: !1})
                }), t
            }

            var t = this, a = $(".pswp")[0];
            $(document).off("click", t.selectors.productImagesPopup), $(document).on("click", t.selectors.productImagesPopup, function (t) {
                t.preventDefault();
                var i = $(".product-single"), r = i.find(".product-single-carousel").data("owl.carousel"),
                ...
                s.init(), s.listen("imageLoadComplete", function () {
            ...
            var e = this, t = this.selectors.productImagesPopup.replace(".", ""),
                a = $(this.selectors.productImageCarousel);
            "complete" === Fastor.status && Fastor.slider(a), a.on("initialized.owl.carousel", function () {
            ...
            function e() {
                var e = s.offset().top + s[0].offsetHeight, t = o.offset().top + m;
                t >= e + p[0].offsetHeight ? (o.css("top", parseInt(o.css("top")) - p[0].offsetHeight), n.removeClass("disabled")) : t > e ? (o.css("top", parseInt(o.css("top")) - a(t - e)), n.removeClass("disabled"), l.addClass("disabled")) : l.addClass("disabled")
            }

            function t() {
                var e = s.offset().top, t = o.offset().top;
                t <= e - p[0].offsetHeight ? (o.css("top", parseInt(o.css("top")) + p[0].offsetHeight), l.removeClass("disabled")) : t < e ? (o.css("top", parseInt(o.css("top")) - a(t - e)), l.removeClass("disabled"), n.addClass("disabled")) : n.addClass("disabled")
            }

            var i = this, r = i.$wrapper;
            if (document.querySelector(this.selectors.productThumbs)) {
                var o = $(this.selectors.productThumbs), s = o.parent(), n = s.find(".thumb-up"),
                    l = s.find(".thumb-down"), d = o.children(), c = d.length, p = d.eq(0), u = this.thumbsIsVertical;
            ...
            if ("undefined" != typeof e && t) {
                var t = $(this.selectors.productThumbs), a = t.children(), i = a.length, r = a.eq(0),
                    o = this.thumbsIsVertical, s = a.eq(e);
                if (o) {
            ...
            this.mqlSmall.matches ? (this.settings.zoomEnabled && this.imageZoomWrapper.forEach(function (e, t) {
                this._destroyZoom(t)
            }.bind(this)), this.settings.bpSmall = !0) : this.settings.bpSmall = !1
            ...
            function e(l, t, e) {
                if (1 < l.options.length) for (var r = 0; r < l.options.length; r++) r != t && a.container.querySelectorAll(o + "-" + r + " option").forEach(function (a) {
                    var o = "unavailable", s = a.getAttribute("value"), d = a.getAttribute("data-swatch");
                    for (j = 0; j < l.variants.length; j++) {
                        var c = l.variants[j];
                        if (c.options[t] != e) continue; else if (c.options[r] == s) {
                ...
                }); else for (var r = 0; r < l.options.length; r++) a.container.querySelectorAll(o + "-0 option").forEach(function (e) {
                    var t = "unavailable", a = e.getAttribute("value"), o = e.getAttribute("data-swatch");
                    for (j = 0; j < l.variants.length; j++) if (l.variants[j].options[r] == a) {
            ...
            if (0 != t.length) {
                var a = this, i = this.selectors.singleOptionSwatchesWrapper, r = this.productSingleObject,
                    o = this.selectors.singleOptionSelectorId;
                t.forEach(function (t) {
                    t.addEventListener("click", function (t) {
                        t.preventDefault();
                        var a = t.target.getAttribute("data-value"), o = t.target.closest(i).querySelector("select"),
                            s = o.value;
                        if (s != a) {
                            o.value = a, o.dispatchEvent(new Event("change", {
                                bubbles: !0,
                                cancelable: !0
                            })), t.target.closest(i).querySelectorAll(".swatch-radio").forEach(function (e) {
                                e.classList.remove("selected")
                            }), t.target.closest(i).querySelectorAll("label").forEach(function (e) {
                                e.classList.remove("label-selected")
                            }), Fastor.Utils.getParents(t.target, "label")[0].classList.add("label-selected");
                            var n = this, l = t.target.getAttribute("data-swatch"),
                                d = t.target.getAttribute("data-poption"), c = t.target.getAttribute("data-value");
                            e(r, d, c, l, n)
                        }
                    }.bind(this))
                }.bind(this))
            ...
            if (document.querySelector(this.selectors.productImageCarousel) && document.querySelector(this.selectors.productThumbs)) {
                var a = $(this.selectors.productThumbs), i = a.children(), r = $(this.selectors.productImageCarousel);
                i.on("click", function () {
                    var e = $(this), t = (e.parent().filter(a).length ? e : e.parent()).index();
                    r.trigger("to.owl.carousel", t, 1)
                }), this.eventHandlers.handleMediaFocus = this._handleMediaFocus.bind(this), r.on("translate.owl.carousel", function (a) {
                    var e = a.item.index;
            ...
            t.innerHTML = e, this.quantityInput && this.quantityInput.classList.add(this.classes.inputError), this.errorMessageWrapper.classList.remove(this.classes.hidden), this.errorMessageWrapper.setAttribute("aria-hidden", !0), this.errorMessageWrapper.removeAttribute("aria-hidden")
            ...
            var e = this.addToCart, t = this.container.querySelector(this.selectors.productForm);
            ...
            var e = this.settings.sectionId, t = this.container.querySelectorAll(this.selectors.productMediaTypeVideo);
            t.forEach(function (t) {
            ...
            if (document.querySelector(t.selectors.productImageCarousel)) {
                ...
                if (!document.querySelector(t.selectors.productThumbImages)) {
                    var i = $("[data-media-id=\"" + e + "\"]").parent().index();
                    a.trigger("to.owl.carousel", i, 100)
                } else $(t.selectors.productThumbImages + "[data-thumbnail-id=\"" + e + "\"]").closest(t.selectors.productThumbListItem).trigger("click")
            }
            ...
            i && (i.dispatchEvent(new CustomEvent("mediaVisible", {
                bubbles: !0,
                cancelable: !0
            })), i.classList.add("media-active"))
            ...
            var i = "", r = theme.Currency.formatMoney(e.price, theme.moneyFormat), o = "", s = "", n = "", l = "";
            return e.compare_at_price > e.price && (i = theme.strings.regularPrice, r = theme.Currency.formatMoney(e.compare_at_price, theme.moneyFormat) + ",", o = theme.strings.sale, s = theme.Currency.formatMoney(e.price, theme.moneyFormat)), e.unit_price && (n = theme.strings.unitPrice, l = theme.Currency.formatMoney(e.unit_price, theme.moneyFormat) + " " + theme.strings.unitPriceSeparator + " " + this._getBaseUnit(e)), t = t.replace("[Regular]", i).replace("[$$]", r).replace("[Sale]", o).replace("[$]", s).replace("[UnitPrice]", n).replace("[$$$]", l).trim(), t
        }, _updateLiveRegion: function (e) {
            var t = e.detail.variant, a = this.container.querySelector(this.selectors.productStatus);
            a.innerHTML = this._liveRegionText(t), a.setAttribute("aria-hidden", !1), setTimeout(function () {
                a.setAttribute("aria-hidden", !0)
            }, 1e3)
        }, _updateAddToCart: function (e) {
            var t = e.detail.variant, a = this.container.querySelector(this.selectors.addToCartText),
                i = this.container.querySelector(this.selectors.productForm);
            this._updateStock(t), t ? t.available ? (this.addToCart.removeAttribute("aria-disabled"), this.addToCart.setAttribute("aria-label", theme.strings.addToCart), a.innerHTML = theme.strings.addToCart, i.classList.remove(this.classes.variantSoldOut)) : (this.addToCart.setAttribute("aria-disabled", !0), this.addToCart.setAttribute("aria-label", theme.strings.soldOut), a.innerHTML = theme.strings.soldOut, i.classList.add(this.classes.variantSoldOut)) : (this.addToCart.setAttribute("aria-disabled", !0), this.addToCart.setAttribute("aria-label", theme.strings.unavailable), a.innerHTML = theme.strings.unavailable, i.classList.add(this.classes.variantSoldOut))
            ...
            var t = e.detail.variant, a = t.featured_media.id, i = this.settings.sectionId + "-" + a;
            this._switchMedia(i)
        }, _updatePrice: function (e) {
            var t = e.detail.variant, a = this.container.querySelector(this.selectors.priceContainer),
                i = a.querySelectorAll(this.selectors.regularPrice), r = a.querySelector(this.selectors.salePrice),
                o = a.querySelector(this.selectors.unitPrice), s = a.querySelector(this.selectors.unitPriceBaseUnit),
                n = function (e, t) {
                    e.innerHTML = theme.Currency.formatMoney(t, theme.moneyFormat)
                };
            return a.classList.remove(this.classes.productUnavailable, this.classes.productOnSale, this.classes.productUnitAvailable, this.classes.productSoldOut), a.removeAttribute("aria-hidden"), this.productPolicies && this.productPolicies.classList.remove(this.classes.visibilityHidden), t ? void (!t.available && a.classList.add(this.classes.productSoldOut), t.compare_at_price > t.price ? (i.forEach(function (e) {
            ...
            return t ? e ? void (null == $(this.selectors.ProductVariantJson).data("stock_" + e.id) ? t.innerHTML = theme.strings.unavailable : "in-stock" == $(this.selectors.ProductVariantJson).data("stock_" + e.id) ? t.innerHTML = theme.strings.inStock : t.innerHTML = theme.strings.soldOut) : void (t.innerHTML = theme.strings.unavailable) : void 0
        }, _updateSKU: function (e) {
            var t = e.detail.variant, a = document.querySelector(this.selectors.SKU);
            a && (a.innerHTML = t.sku)
    ...
    function e(e) {
        this.container = e, this.containerSelect = "#" + e.id, this.thumbnails = this.container.querySelectorAll(t.thumbnails), this.quantityInputs = this.container.querySelectorAll(t.inputQty), this.ajaxEnabled = "true" === this.container.getAttribute("data-ajax-enabled"), this._handleInputQty = theme.Helpers.debounce(this._handleInputQty.bind(this), 500), this._onNoteChange = this._onNoteChange.bind(this), this._onRemoveItem = this._onRemoveItem.bind(this), theme.Helpers.cookiesEnabled() || this.container.classList.add(a.cartNoCookies), this.thumbnails.forEach(function (e) {
            e.style.cursor = "pointer"
        }), this.container.addEventListener("click", this._handleThumbnailClick), on(this.containerSelect, "change", t.quantityInput, this._handleInputQty.bind(this)), this.mql = window.matchMedia(r), this.ajaxEnabled && (this.container.addEventListener("click", this._onRemoveItem), this.container.addEventListener("change", this._onNoteChange), this._setupCartTemplates())
    }
    ...
    return e.prototype = Object.assign({}, e.prototype, {
        _setupCartTemplates: function () {
            ...
            e && (this.itemTemplate = this.container.querySelector(t.cartItem).cloneNode(!0), this.itemDiscountTemplate = this.itemTemplate.querySelector(t.cartItemDiscount).cloneNode(!0), this.cartDiscountTemplate = this.container.querySelector(t.cartDiscount).cloneNode(!0), this.itemPriceListTemplate = this.itemTemplate.querySelector(t.cartItemPriceList).cloneNode(!0), this.itemOptionTemplate = this.itemTemplate.querySelector(t.cartItemOption).cloneNode(!0), this.itemPropertyTemplate = this.itemTemplate.querySelector(t.cartItemProperty).cloneNode(!0), this.itemSellingPlanNameTemplate = this.itemTemplate.querySelector(t.cartItemSellingPlanName).cloneNode(!0))
            ...
            if (e.target.hasAttribute("data-quantity-input")) {
                ...
                var a = e.target, i = a.closest(t.cartItem), r = +a.getAttribute("data-quantity-item"),
                    o = this.container.querySelectorAll("[data-quantity-item='" + r + "']"), s = parseInt(a.value),
                    n = !(0 > s || isNaN(s));
                return o.forEach(function (e) {
                    e.value = s
                }), this._hideCartError(), this._hideQuantityErrorMessage(), n ? void (n && this.ajaxEnabled && this._updateItemQuantity(r, i, o, s)) : void this._showQuantityErrorMessages(i)
            }
        }, _updateItemQuantity: function (e, a, r, o) {
            var s = a.getAttribute(i.cartItemKey), n = +a.getAttribute(i.cartItemIndex), l = {
                method: "POST",
                headers: {"Content-Type": "application/json;"},
                body: JSON.stringify({line: n, quantity: o})
            };
            fetch("/cart/change.js", l).then(function (e) {
                ...
                var i = document.querySelector("[data-cart-item-key='" + s + "']"), r = this.getItem(s, e),
            ...
            var a = "", i = theme.Currency.formatMoney(e.original_line_price, theme.moneyFormat), r = "", o = "",
                s = "";
            return e.original_line_price > e.final_line_price && (a = theme.strings.regularTotal, r = theme.strings.discountedTotal, o = theme.Currency.formatMoney(e.final_line_price, theme.moneyFormat), s = theme.strings.priceColumn), t = t.replace("[Regular]", a).replace("[$$]", i).replace("[DiscountedPrice]", r).replace("[$]", o).replace("[PriceInformation]", s).trim(), t
        }, _updateLiveRegion: function (e) {
            if (e) {
            ...
            var i = this._createCartDiscountList(e), r = this.container.querySelector(t.cartLineItems);
            r.innerHTML = "", this._createLineItemList(e).forEach(function (e) {
                r.appendChild(e)
            }), this.cartNotes = this.cartNotes || this.container.querySelector(t.cartNote), this.cartNotes && (this.cartNotes.value = e.note);
            var o = this.container.querySelector(t.cartDiscountWrapper);
            0 === i.length ? (o.innerHTML = "", o.classList.add(a.hide)) : (o.innerHTML = "", i.forEach(function (e) {
                o.appendChild(e)
            }), o.classList.remove(a.hide)), this.container.querySelector(t.cartSubtotal).textContent = theme.Currency.formatMoney(e.total_price, theme.moneyFormatWithCurrency), this.container.querySelector(t.cartTotal).textContent = theme.Currency.formatMoney(e.total_price, theme.moneyFormatWithCurrency)
            ...
            return e.items.map(function (e, a) {
                var i = this.itemTemplate.cloneNode(!0), r = this.itemPriceListTemplate.cloneNode(!0);
                ...
                this._setProductDetailsList(i, n), this._setItemRemove(i, e.title), r.innerHTML = this._createItemPrice(e.original_price, e.final_price).outerHTML, e.unit_price_measurement && r.appendChild(this._createUnitPrice(e.unit_price, e.unit_price_measurement)), this._setItemPrice(i, r);
            ...
            return i.length ? (r.classList.remove(a.hide), void (r.innerHTML = i.reduce(function (e, t) {
            ...
            0 === i.length ? (r.innerHTML = "", r.classList.add(a.hide)) : (r.innerHTML = i.reduce(function (e, t) {
                return e + t.outerHTML
            ...
            var i = null === e ? [] : Object.entries(e), r = i.filter(function (e) {
                return "_" !== e[0].charAt(0) && 0 !== e[1].length
            });
            return r.map(function (e) {
                var i = this.itemPropertyTemplate.cloneNode(!0);
                return i.querySelector(t.cartItemPropertyName).textContent = e[0] + ": ", -1 === e[0].indexOf("/uploads/") ? i.querySelector(t.cartItemPropertyValue).textContent = e[1] : i.querySelector(t.cartItemPropertyValue).innerHTML = "<a href=\"" + e[1] + "\"> " + e[1].split("/").pop() + "</a>", i.classList.remove(a.hide), i
            }.bind(this))
            ...
            var r, o = theme.Currency.formatMoney(e, theme.moneyFormat);
            ...
            if (e.target.hasAttribute("data-cart-notes")) {
                ...
                fetch("/cart/update.js", i).catch(function () {
            ...
            if (e.target.hasAttribute("data-cart-remove")) {
                e.preventDefault();
                var a = e.target.closest(t.cartItem), r = +a.getAttribute(i.cartItemIndex);
                this._hideCartError();
                var o = {
                    method: "POST",
                    headers: {"Content-Type": "application/json;"},
                    body: JSON.stringify({line: r, quantity: 0})
                };
                fetch("/cart/change.js", o).then(function (e) {
                    return e.json()
                }).then(function (e) {
            ...
            var t = e.getAttribute("data-cart-item-index"), a = this._getRemoveMessage(e);
            0 == t - 1 ? this.container.querySelector("[data-cart-item-index=\"1\"]").insertAdjacentHTML("beforebegin", a.outerHTML) : this.container.querySelector("[data-cart-item-index='" + (t - 1) + "']").insertAdjacentHTML("afterend", a.outerHTML), this.container.querySelector("[data-removed-item-row]").focus()
        }, _getRemoveMessage: function (e) {
            var i = this._formatRemoveMessage(e), r = e.querySelector(t.cartTableCell).cloneNode(!0);
            return r.removeAttribute("class"), r.classList.add(a.cartRemovedProduct), r.setAttribute("colspan", "6"), r.innerHTML = i, e.setAttribute("role", "alert"), e.setAttribute("tabindex", "-1"), e.setAttribute("data-removed-item-row", !0), e.innerHTML = r.outerHTML, e
        }, _formatRemoveMessage: function (e) {
            var t = e.getAttribute("data-cart-item-quantity"), a = e.getAttribute(i.cartItemUrl),
            ...
            this.emptyPageContent = this.emptyPageContent || this.container.querySelector(t.emptyPageContent), this.cartWrapper = this.cartWrapper || this.container.querySelector(t.cartWrapper), this.emptyPageContent.classList.remove(a.hide), this.cartWrapper.classList.add(a.hide)
        }
    }), e
}(), theme.ShippingCalculator = function () {
    function ShippingCalculator(e) {
        var t = this.$container = $(e), a = t.attr("data-section-id");
        this.selectors = {
    ...
    return ShippingCalculator.prototype = Object.assign({}, ShippingCalculator.prototype, {
        _disableButtons: function () {
            ...
            var t = this.selectors, a = this.strings, i = $(t.template), r = $(t.response);
            if (r.length) {
                if (!e.success) i.addClass("error"), i.append(e.errorFeedback); else if (i.addClass("success"), e.rates) {
                    i.append(e.rates);
                    var o = e.rates;
                    if (o[0]) {
                        var s = o[0];
            ...
            var a = this, r = this.selectors, o = this.strings;
            a._enableButtons();
            var s = "";
            ...
            var t = this, a = this.selectors, i = this.strings, r = function () {
                $.ajax("/cart/async_shipping_rates", {
                    dataType: "json", success: function (a, i, o) {
            ...
            var t = this.selectors, a = this.strings, i = [];
            ...
            feedback = data.message ? data.message + "(" + data.status + "): " + data.description : "Error : " + self._fullMessagesFromErrors(data).join("; ") + ".", "Error : country is not supported." === feedback && (feedback = theme.strings.doNotShip), self._render({
                rates: [],
                errorFeedback: feedback,
                success: !1
            }), $(selectors.response).show()
        }, _getCartShippingRatesForDestination: function (e) {
            var t = this, a = this.selectors, i = this.strings;
            $.ajax({
                type: "POST",
            ...
            var e = this, t = this.selectors, a = this.strings;
            if ($(t.shipping_calculator).length) {
                ...
                var i = $("#" + t.address_country), r = $("#" + t.address_province_label).get(0);
                "undefined" != typeof Countries && (Countries.updateProvinceLabel(i.val(), r), i.change(function () {
...
}(), window.theme = window.theme || {}, theme.customerTemplates = function () {
    function e() {
        ...
        var e = document.getElementById("RecoverPassword"), o = document.getElementById("RecoverPasswordHeader"),
            s = document.getElementById("register-agree"), n = document.getElementById("HideRecoverPasswordLinkHeader"),
            d = document.getElementById("HideRecoverPasswordLink");
        $("a.login.popup-modal:not(.logged), .login-link").on("click", function (t) {
            t.preventDefault(), Fastor.popup({
                items: {src: $(this).attr("href"), type: "inline"},
                tLoading: "",
        ...
        }.bind(this)), o && o.addEventListener("click", function (e) {
            e.preventDefault(), t()
        }.bind(this)), e && e.addEventListener("click", function (e) {
            e.preventDefault(), i(), this.recoverHeading.setAttribute("tabindex", "-1"), this.recoverHeading.focus()
        }.bind(this)), n && n.addEventListener("click", function (e) {
            e.preventDefault(), a()
        }.bind(this)), d && d.addEventListener("click", function (e) {
    ...
    function t() {
        document.getElementById("RecoverPasswordFormHeader").classList.remove("hide"), document.getElementById("CustomerLoginFormHeader").classList.add("hide"), "true" === this.recoverEmail.getAttribute("aria-invalid") && this.recoverEmail.focus()
    }
    ...
    function s() {
        var e = document.getElementById("AddressNewForm"), t = document.getElementById("AddressNewButton");
        e && (Shopify && new Shopify.CountryProvinceSelector("AddressCountryNew", "AddressProvinceNew", {hideElement: "AddressProvinceContainerNew"}), document.querySelectorAll(".address-country-option").forEach(function (e) {
            ...
            e.addEventListener("click", function (e) {
                var t = e.target.dataset.formId, a = document.getElementById("EditFormButton_" + t),
                    i = document.getElementById("EditAddress_" + t), r = "true" === a.getAttribute("aria-expanded");
            ...
            e.addEventListener("click", function (e) {
                var t = e.target.dataset.target, a = e.target.dataset.confirmMessage;
...
}(), window.theme = window.theme || {}, theme.BlogSection = function () {
    function e(e) {
        var t = this.sectionId = e.dataset.sectionId;
        this.container = e, this.sectionNamspace = "#" + t, this._init()
    }
    ...
    Fastor.handleCartForm = function (e, t) {
        fetch("/cart/add.js", {
            ...
            body: theme.Helpers.serialize(t)
        }).then(function (e) {
            return e.json()
        }).then(function (t) {
        ...
        t ? (e.classList.add("position-relative"), null != e.querySelector("i") && (e.querySelector("i").classList.add("position-static"), e.querySelector("i").classList.add("loading"), e.disabled = !0)) : (e.disabled = !1, e.classList.remove("position-relative"), null != e.querySelector("i") && (e.querySelector("i").classList.remove("position-static"), e.querySelector("i").classList.remove("loading")))
        ...
        var o = theme.strings.cartSuccess + "<a href=\"/cart\" class=\"btn btn-link btn-sm\">" + theme.strings.cartView + "<i class=\"la la-shopping-cart\"></i></a>",
            s = e.product_title, n = e.url,
            l = l = "<div class=\"price\">" + theme.Currency.formatMoney(e.final_price, theme.moneyFormat) + "</div>";
        Fastor.updateCart(), Fastor.notifpopup.open({
            message: o,
            productClass: " product-cart product-cart-success",
            name: s,
            nameLink: n,
            imageSrc: i,
            imageAlt: r,
        ...
        if (null !== a && 0 !== Object.keys(a).length) {
            var s = "", n = null === a ? [] : Object.entries(a), l = n.filter(function (e) {
                return "_" !== e[0].charAt(0) && 0 !== e[1].length
            });
            l.map(function (e) {
                if (-1 === e[0].indexOf("/uploads/")) var t = e[1]; else var t = "<a href=\"" + e[1] + "\"> " + e[1].split("/").pop() + "</a>";
        ...
        Fastor.notifpopup.open({
            message: e,
            productClass: " product-cart product-cart-error",
            name: "",
            nameLink: "",
            imageSrc: "",
            imageLink: "",
        ...
        fetch("/search?view=cart&direct=false").then(function (e) {
            return e.text()
        }).then(function (e) {
            document.querySelectorAll(".cart-dropdown").forEach(function (t) {
                var a = new DOMParser, i = a.parseFromString(e, "text/html");
        ...
        e.forEach(function (e) {
            e.addEventListener("click", function (e) {
                e.preventDefault();
                var t = e.target.closest("[data-cart-item]"), a = +t.getAttribute("data-cart-item-index"), i = {
                    method: "POST",
                    headers: {"Content-Type": "application/json;"},
                    body: JSON.stringify({line: a, quantity: 0})
                };
                fetch("/cart/change.js", i).then(function (e) {
                    return e.json()
                }).then(function () {
                    Fastor.updateCart()
                }.bind(this))
        ...
        t(document).off("click", ".fastor-popup-open"), t(document).on("click", ".fastor-popup-open", function (a) {
            a.preventDefault();
            var e = this, i = e.getAttribute("data-handle"), r = e.getAttribute("data-wrapper");
            t.ajax({
                url: "/search",
        ...
        }), t(document).off("click", ".fastor__modal-close"), t(document).on("click", ".fastor__modal-close", function (a) {
        ...
        var r = "<div class=\"alert-popup\"><div class=\"alert alert-" + ("check" == e ? "success" : "error") + " alert-message d-flex\"><div class=\"alert__icon mr-2\"><i class=\"la la-" + e + "\"></i></div><div class=\"alert__content\">" + a + "</div></div></div>";
        !0 == i && (r = "<div class=\"alert-popup\"><div class=\"alert alert-message show cart_message\"><div class=\"alert__background\" style=\"background-image:url(" + e + ");\"></div><div class=\"alert__description\">" + a + "</div></div></div>"), t("body .page-wrapper").append(r), setTimeout(function () {
        ...
        return !!t(".addwishlist_btn").length && void (t(document).off("click", ".addwishlist_btn:not(.added)"), t(document).on("click", ".addwishlist_btn:not(.added)", function (e) {
            e.preventDefault();
            var a = this, i = t(this), r = parseInt(i.data("customer_id"));
            if (0 < r) {
                var o = i.data("shop_domain"), s = parseInt(i.data("product_id")),
                ...
                if (o.length && n.length && s) {
                    ...
                    m.setAttribute("type", "hidden"), m.setAttribute("name", "action"), m.setAttribute("value", "add_wishlist"), l.appendChild(d), l.appendChild(c), l.appendChild(p), l.appendChild(u), l.appendChild(m), t("body").append(l);
                    var g = t(l).serialize();
                    t.ajax({
                        type: "POST",
                        url: "/a/wishlist",
        ...
        return !!t(".removewishlist_btn").length && void (t(document).off("click", ".removewishlist_btn"), t(document).on("click", ".removewishlist_btn", function () {
            var e = t(this), a = parseInt(e.data("customer_id"));
            if (0 < a) {
                var i = e.data("shop_domain"), r = parseInt(e.data("product_id"));
                if (i.length && r) {
                    ...
                    t.ajax({
                        ...
                        success: function (a) {
                            if (t(o).remove(), 1 == a.code) {
                                ...
                                i ? e.closest("tr").slideUp("fast", function () {
        ...
        function e(e) {
            ...
            i.removeClass("opened"), e && e.length && i.find(".fastor__modal-content").empty().html(e), i.addClass("opened"), t(".compare__list tr").each(function () {
                t(this).css("height", t(this).outerHeight())
            }), t(".compare__list").clone().appendTo(".compare__left"), t(".compare__left td").remove()
        }
        ...
        (function () {
            var e = i();
            e.length && t(".addcompare_btn").each(function () {
                var a = t(this), i = a.data("product_id");
                e.includes(i) && a.addClass("added").find("span").text(a.data("added"))
            }), t(document).off("click", ".fastor__modal-close"), t(document).on("click", ".fastor__modal-close", function () {
                a()
            }), t(document).keyup(function (e) {
                "27" == e.which && t(".compare__modal").hasClass("opened") && a()
            })
        })(), function () {
            t(document).off("click", ".addcompare_btn"), t(document).on("click", ".addcompare_btn", function (a) {
                a.preventDefault();
                var o = this, s = t(this), n = i(), l = s.data("product_id");
                n.includes(l) || n.unshift(l), 10 <= n.length && Fastor.openAlert("alert", theme.strings.compareLimit);
                var d = r(n), c = d.map(function (e) {
                    return "id:" + e
                }).join(" OR ");
                t.ajax({
                    url: "/search",
            ...
            t(document).off("click", ".removecompare_btn"), t(document).on("click", ".removecompare_btn", function (e) {
                e.preventDefault();
                var o = t(this), s = o.data("product_id"), n = ".product__" + s, l = i();
        ...
        document.addEventListener("click", function (e) {
            if (e.target.hasAttribute("data-quantity-input-minus") || e.target.hasAttribute("data-quantity-input-plus")) {
                var t = e.target.closest(".quantity-wrapper").querySelector("[data-quantity-input]"),
                    a = parseInt(t.value);
                e.target.hasAttribute("data-quantity-input-minus") ? 1 < a && (t.value = a - 1, t.dispatchEvent(new Event("change", {
                    bubbles: !0,
                    cancelable: !0
        ...
        null == document.querySelectorAll(".addcart-product-form") || (t(document).off("submit", "form.addcart-product-form"), t(document).on("submit", "form.addcart-product-form", function (e) {
            if ("direct" != theme.addToCartType) {
                e.preventDefault();
                var t = this, a = this.querySelector("button[type=\"submit\"]");
        ...
        if (0 != t("#grouped-price").length) {
            ...
            t(".grouped-product-item .grouped-checkbox").each(function () {
                t(this).is(":checked") && (e += parseFloat(t(t(this).data("id")).find(".product-price").attr("data-price")), a += 0 < parseFloat(t(t(this).data("id")).find(".product-price").attr("data-price_old")) ? parseFloat(t(t(this).data("id")).find(".product-price").attr("data-price_old")) : parseFloat(t(t(this).data("id")).find(".product-price").attr("data-price")))
            }), t("#grouped-price").html(theme.Currency.formatMoney(e, theme.moneyFormat)), a > e ? t("#grouped-price-old").removeClass("hide").html(theme.Currency.formatMoney(a, theme.moneyFormat)) : t("#grouped-price-old").addClass("hide").html(theme.Currency.formatMoney(a, theme.moneyFormat))
        }
    }, Fastor.handleQuickView = function () {
        null == document.querySelectorAll(".btn-quickview") || (t(document).off("click", ".btn-quickview"), t(document).on("click", ".btn-quickview", function (e) {
            e.preventDefault();
            var a = t(this), i = a.data("handle");
            a.find("i").addClass("position-static").addClass("loading"), a.prop("disable", !0), Fastor.popup({
                ...
                callbacks: {
                    ajaxContentAdded: function () {
                        ...
                        }), a.find("i").removeClass("position-static").removeClass("loading"), a.prop("disable", !1)
                    }
                }
            }, "quickview")
        }))
